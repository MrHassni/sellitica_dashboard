...
//--
  ...
  static final String groupReplyTo = 'replyto';
  ...
  static final String groupmsgPoll = 'polloptions';
  static final String grouppollwillend = 'pollwillend';
  ...
  static final String targetshops = 'targetshops';
  static final String targetorders = 'targetorders';
  static final String visitedshops = 'visitedshops';
  static final String remainingshops = 'remainingshops';
  ...
  static final String checkno = 'chequeno';
  static final String fromaccount = 'fromaccount';
  static final String toaccount = 'toaccount';
  static final String transactionid = 'transactionID';
  static final String paymentmethod = 'paymentmethod';
  static final String isTracking = 'isTracking';
  static final String grandtotal = 'grandtotal';
  static final String note = 'note';
  static final String numberofproducts = 'numberofproducts';
  ...
  static final String saleperson = 'saleperson';
  static final String invoiceno = 'invoiceno';
  ...
  //---SharedPrefrences
  static final String lastAttendanceDate = 'lastAttendanceDate';
}
